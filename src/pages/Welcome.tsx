...
export function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-base px-4 py-8 text-ink sm:px-6">
      <header className="mx-auto flex max-w-[900px] items-center justify-between"><img src="/Logo.jpeg" alt="ZORA" className="h-9 w-[120px] rounded object-cover object-center" /><Link to="/emergency" className="inline-flex min-h-11 items-center gap-2 rounded-xl border border-coral/40 bg-coral-soft px-3 text-sm font-semibold text-coral"><ShieldAlertIcon aria-hidden className="h-4 w-4" /> SOS</Link></header>
